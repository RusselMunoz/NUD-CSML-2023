...
plt.bar(election_results.keys(), election_results.values())
plt.title("Midterm Election Results", fontdict={'fontsize': 14, 'fontweight': 'bold'})
plt.xlabel("Senator", fontdict={'fontsize': 12})
plt.ylabel("Votes", fontdict={'fontsize': 12})
