...
public class RegistrationForm extends javax.swing.JFrame {
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if ("".equals(ID)){
                ...
                String sql = "SELECT * From product Where product_id Statement sttmnt = " + ID;
                ...
                if (rs.next()){
                    ...
                    Statement updSttmnt = con.createStatement();
                    updSttmnt.executeUpdate(sq12);
                    updSttmnt.close();
                    loadData();
                }
                rs.close();
    ...
    private void productJTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_productJTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_productJTextActionPerformed
